        ...
        <div class="container">
            <div class="handle-box">
                <el-form :inline="true" label-width="auto" :model="query" class="demo-form-inline">
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="发票申请单">
                                <el-input v-model="query.fapiaoNo" placeholder="发票申请单" class="" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="销货单">
                                <el-input v-model="query.saleDeliveryCode" placeholder="销货单" class="" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="8">
                            <el-form-item label="开票单状态">
                                <el-select v-model="query.status" placeholder="开票单状态" class=" status">
            ...
            <div style="padding: 10px; ">
                <h2 style="margin: 20px 0;">发票申请列表</h2>
                <el-divider />
            </div>
            <el-table :data="invoice.invoiceList" class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="fapiaoNo" label="发票申请单号" width="200"></el-table-column>
                <el-table-column show-overflow-tooltip label="抬头">
                    <template #default="scope">{{ scope.row.custName }}</template>
                </el-table-column>
                <el-table-column prop="custTaxid" label="税号" width="200"></el-table-column>
                <el-table-column prop="amount" label="开票金额"></el-table-column>
                <el-table-column prop="fpTitle" label="开票内容"></el-table-column>
                <el-table-column prop="status" label="开票单状态">
